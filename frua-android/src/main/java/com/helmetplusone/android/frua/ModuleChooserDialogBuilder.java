 ...
 * Date: 3/31/13
 */
class ModuleChooserDialogBuilder {
    ...
    ModuleChooserDialogBuilder(SettingsActivity context) {
    ...
    Dialog build() {
        ...
        dialog.setTitle(context.getResources().getString(R.string.menu_add_module_dialog_title));
        // buttons
    ...
    private class OkListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            new AddModuleTask(context, dialog, new File(source), new File(target)).execute();
        }
    }
    ...
    private class ItemListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            File ch = TO_PARENT_DIR.equals(text) ? curdir.getParentFile() : new File(curdir, text);
            if (ch.isFile()) {
