...
bool dynamic_check(localFile *u) {Bit16u info = u->GetInformation(); return  ((!info) || (info == 0x40));}
bool dynamic_check(localDrive *u) {return !strncmp(u->info, "local directory ", 16);}
bool dynamic_check(fatDrive *u) {return true;}	//2011-07-24, locnet, set to true to enable hdd imgmount
